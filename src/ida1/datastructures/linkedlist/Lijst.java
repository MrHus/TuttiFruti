package ida1.datastructures.linkedlist;
...
public class Lijst 
{
    ...
    /**
     * Updated remove so that even the header can be removed.
     * When this happens it will create a new header by calling clear().
     *
     * @param e
     */
